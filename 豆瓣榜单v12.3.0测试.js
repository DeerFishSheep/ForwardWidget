// =============UserScript=============
// @name         豆瓣聚合引擎 (终极完美版 - 修复UI联动展开Bug)
// @version      12.3.0
// @description  彻底解决首次进入不展开参数的底层Bug，完善榜单自动命名与默认值
// @author       YourName
// =============UserScript=============
...
var WidgetMetadata = {
    ...
    modules: [
        ...
        {
            title: "豆瓣·类型榜单大全",
            description: "💡 如未显示细分榜单，请重新点击选择一次影视类型",
            requiresWebView: false,
            functionName: "loadDoubanGenreRankings",
            params: [
                {
                    name: "r_media_type", title: "🎬 影视类型", type: "enumeration", value: "movie",
                    enumOptions: [ { title: "电影", value: "movie" }, { title: "电视剧", value: "tv" } ]
                },
                {
                    name: "r_movie_cat", title: "📁 电影分类", type: "enumeration", value: "剧情",
                    belongTo: { paramName: "r_media_type", value: ["movie"] },
                    enumOptions: [
                ...
                {
                    name: "r_tv_cat", title: "📁 剧集分类", type: "enumeration", value: "大陆剧",
                    belongTo: { paramName: "r_media_type", value: ["tv"] },
                    enumOptions: [
                ...
                // 电影三级分类
                { name: "r_movie_sub_剧情", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_27", belongTo: { paramName: "r_movie_cat", value: ["剧情"] }, enumOptions: [ { title: "高分经典剧情片榜", value: "film_genre_27" } ] },
                { name: "r_movie_sub_喜剧", title: "🔖 榜单名称", type: "enumeration", value: "ECAYN54KI", belongTo: { paramName: "r_movie_cat", value: ["喜剧"] }, enumOptions: [ { title: "近期热门喜剧片榜", value: "ECAYN54KI" }, { title: "高分经典喜剧片榜", value: "movie_comedy" }, { title: "华语喜剧片榜", value: "ECVUOUD7A" }, { title: "欧洲喜剧片榜", value: "ECPQO4BPA" }, { title: "中国大陆喜剧片榜", value: "ECKIO6SXI" }, { title: "美国喜剧片榜", value: "ECGUO62ZA" }, { title: "中国香港喜剧片榜", value: "ECOYO2QPA" }, { title: "中国台湾喜剧片榜", value: "ECEAOX2BI" }, { title: "日本喜剧片榜", value: "ECFIOT7JA" }, { title: "韩国喜剧片榜", value: "ECOIOVQPY" }, { title: "英国喜剧片榜", value: "EC6IOYROI" }, { title: "法国喜剧片榜", value: "ECIEOY5UI" }, { title: "德国喜剧片榜", value: "ECFQO5B4A" }, { title: "意大利喜剧片榜", value: "ECREOTSEI" }, { title: "西班牙喜剧片榜", value: "EC6UO37NQ" }, { title: "瑞典喜剧片榜", value: "ECPMPBHBI" }, { title: "印度喜剧片榜", value: "ECTIOYBOY" }, { title: "泰国喜剧片榜", value: "ECAIO3EWI" }, { title: "加拿大喜剧片榜", value: "ECYUPAHZY" }, { title: "澳大利亚喜剧片榜", value: "ECKMOXL6Q" }, { title: "爱尔兰喜剧片榜", value: "ECOAOZY7Y" }, { title: "冷门佳作喜剧片榜", value: "ECLYOFOKA" } ] },
                { name: "r_movie_sub_爱情", title: "🔖 榜单名称", type: "enumeration", value: "ECSAOJFTA", belongTo: { paramName: "r_movie_cat", value: ["爱情"] }, enumOptions: [ { title: "近期热门爱情片榜", value: "ECSAOJFTA" }, { title: "高分经典爱情片榜", value: "movie_love" }, { title: "华语爱情片榜", value: "ECOIOTUGY" }, { title: "欧洲爱情片榜", value: "ECUAOYUCA" }, { title: "中国大陆爱情片榜", value: "EC64OQVEQ" }, { title: "美国爱情片榜", value: "EC4EOSAQA" }, { title: "中国台湾爱情片榜", value: "ECWQOQO4A" }, { title: "日本爱情片榜", value: "ECKMOVF3Y" }, { title: "韩国爱情片榜", value: "ECHIOXXIQ" }, { title: "英国爱情片榜", value: "ECHAO4AAQ" }, { title: "法国爱情片榜", value: "ECTAOT7GQ" }, { title: "德国爱情片榜", value: "ECNIOS7EQ" }, { title: "意大利爱情片榜", value: "EC3UOSWUY" }, { title: "西班牙爱情片榜", value: "ECU4OWMMI" }, { title: "瑞典爱情片榜", value: "ECCEOUVAA" }, { title: "印度爱情片榜", value: "ECLUOQWVY" }, { title: "泰国爱情片榜", value: "ECYQO7YPQ" }, { title: "加拿大爱情片榜", value: "ECEAOXFIQ" }, { title: "澳大利亚爱情片榜", value: "ECOUOXYUA" }, { title: "爱尔兰爱情片榜", value: "ECJMO2O5Y" }, { title: "冷门佳作爱情片榜", value: "EC2UOKRRQ" } ] },
                { name: "r_movie_sub_动作", title: "🔖 榜单名称", type: "enumeration", value: "ECBUOLQGY", belongTo: { paramName: "r_movie_cat", value: ["动作"] }, enumOptions: [ { title: "近期热门动作片榜", value: "ECBUOLQGY" }, { title: "高分经典动作片榜", value: "movie_action" }, { title: "华语动作片榜", value: "EC2YO2M2A" }, { title: "欧洲动作片榜", value: "ECHUOXOUA" }, { title: "美国动作片榜", value: "ECPMPC7JA" }, { title: "中国台湾动作片榜", value: "ECTMO64KY" }, { title: "日本动作片榜", value: "ECBAPBW2Y" }, { title: "韩国动作片榜", value: "ECWQOU2HI" }, { title: "英国动作片榜", value: "ECCUPDBHQ" }, { title: "法国动作片榜", value: "EC5UOWEFY" }, { title: "德国动作片榜", value: "EC7AOW57Q" }, { title: "印度动作片榜", value: "ECMQO4F2I" }, { title: "加拿大动作片榜", value: "ECUQPDN7Y" }, { title: "澳大利亚动作片榜", value: "EC4QPALEI" }, { title: "冷门佳作动作片榜", value: "ECVIOHY6A" } ] },
                { name: "r_movie_sub_科幻", title: "🔖 榜单名称", type: "enumeration", value: "ECZYOJPLI", belongTo: { paramName: "r_movie_cat", value: ["科幻"] }, enumOptions: [ { title: "近期热门科幻片榜", value: "ECZYOJPLI" }, { title: "高分经典科幻片榜", value: "movie_scifi" }, { title: "欧洲科幻片榜", value: "ECX4O7JAA" }, { title: "美国科幻片榜", value: "ECDAO6XZI" }, { title: "日本科幻片榜", value: "ECSYOV6GY" }, { title: "英国科幻片榜", value: "EC4UOZQ4Y" }, { title: "法国科幻片榜", value: "EC3MO34NI" }, { title: "德国科幻片榜", value: "ECOUO2ETY" }, { title: "加拿大科幻片榜", value: "ECX4PAGTA" }, { title: "澳大利亚科幻片榜", value: "ECTAOXLWQ" }, { title: "冷门佳作科幻片榜", value: "EC2IOENJA" } ] },
                { name: "r_movie_sub_动画", title: "🔖 榜单名称", type: "enumeration", value: "EC3UOBDQY", belongTo: { paramName: "r_movie_cat", value: ["动画"] }, enumOptions: [ { title: "近期热门动画片榜", value: "EC3UOBDQY" }, { title: "高分经典动画片榜", value: "film_genre_31" }, { title: "华语动画片榜", value: "ECFMOYMKA" }, { title: "欧洲动画片榜", value: "ECLYO57HA" }, { title: "美国动画片榜", value: "EC4IPDWYI" }, { title: "日本动画片榜", value: "ECLYO6JQQ" }, { title: "英国动画片榜", value: "ECWUO3RJA" }, { title: "法国动画片榜", value: "ECIQPF7NY" }, { title: "加拿大动画片榜", value: "EC3YPB7WQ" }, { title: "冷门佳作动画片榜", value: "ECTUO3I3A" } ] },
                { name: "r_movie_sub_悬疑", title: "🔖 榜单名称", type: "enumeration", value: "ECPQOJP5Q", belongTo: { paramName: "r_movie_cat", value: ["悬疑"] }, enumOptions: [ { title: "近期热门悬疑片榜", value: "ECPQOJP5Q" }, { title: "高分经典悬疑片榜", value: "film_genre_32" }, { title: "华语悬疑片榜", value: "ECRMOX2JI" }, { title: "欧洲悬疑片榜", value: "ECUMPB7SA" }, { title: "美国悬疑片榜", value: "ECJUO3L7I" }, { title: "中国香港悬疑片榜", value: "ECV4OU2WA" }, { title: "日本悬疑片榜", value: "ECVYOVDIA" }, { title: "韩国悬疑片榜", value: "ECSYOYZWI" }, { title: "英国悬疑片榜", value: "EC5YPE3OI" }, { title: "法国悬疑片榜", value: "ECQUO7FVQ" }, { title: "德国悬疑片榜", value: "ECZQO7KSQ" }, { title: "意大利悬疑片榜", value: "ECVEO7MPI" }, { title: "西班牙悬疑片榜", value: "ECAYOVXFA" }, { title: "加拿大悬疑片榜", value: "ECYMPDCTI" }, { title: "澳大利亚悬疑片榜", value: "ECIMOWR2I" }, { title: "冷门佳作悬疑片榜", value: "ECK4OEBJY" } ] },
                { name: "r_movie_sub_犯罪", title: "🔖 榜单名称", type: "enumeration", value: "ECLAN6LHQ", belongTo: { paramName: "r_movie_cat", value: ["犯罪"] }, enumOptions: [ { title: "近期热门犯罪片榜", value: "ECLAN6LHQ" }, { title: "高分经典犯罪片榜", value: "film_genre_46" }, { title: "华语犯罪片榜", value: "ECVUO4O4Q" }, { title: "欧洲犯罪片榜", value: "EC5QO2HUI" }, { title: "中国大陆犯罪片榜", value: "ECWAPHUIA" }, { title: "美国犯罪片榜", value: "ECEAPADKY" }, { title: "中国香港犯罪片榜", value: "EC3AOZZUY" }, { title: "日本犯罪片榜", value: "ECVUO43DY" }, { title: "韩国犯罪片榜", value: "ECGYO2SPA" }, { title: "英国犯罪片榜", value: "ECVYOZNAI" }, { title: "法国犯罪片榜", value: "ECFEPCR2A" }, { title: "德国犯罪片榜", value: "ECVAPBWRI" }, { title: "意大利犯罪片榜", value: "ECRMO4X7I" }, { title: "西班牙犯罪片榜", value: "ECPAPDKZA" }, { title: "加拿大犯罪片榜", value: "EC2MPBOOI" }, { title: "澳大利亚犯罪片榜", value: "ECEMOZ6DI" }, { title: "冷门佳作犯罪片榜", value: "EC7EOG3RI" } ] },
                { name: "r_movie_sub_惊悚", title: "🔖 榜单名称", type: "enumeration", value: "ECBUOL2DA", belongTo: { paramName: "r_movie_cat", value: ["惊悚"] }, enumOptions: [ { title: "近期热门惊悚片榜", value: "ECBUOL2DA" }, { title: "高分经典惊悚片榜", value: "film_genre_33" }, { title: "华语惊悚片榜", value: "EC5MPCA7Y" }, { title: "欧洲惊悚片榜", value: "ECTMPCZTY" }, { title: "美国惊悚片榜", value: "ECSYO3JKQ" }, { title: "日本惊悚片榜", value: "ECFUO25PI" }, { title: "韩国惊悚片榜", value: "ECTMPDECI" }, { title: "英国惊悚片榜", value: "ECU4O6QYQ" }, { title: "法国惊悚片榜", value: "ECPMPHOMI" }, { title: "德国惊悚片榜", value: "ECJIPH4JA" }, { title: "意大利惊悚片榜", value: "EC2QPBTHY" }, { title: "西班牙惊悚片榜", value: "ECLMPAEZY" }, { title: "瑞典惊悚片榜", value: "ECMIPBWCY" }, { title: "印度惊悚片榜", value: "ECRQPBSYI" }, { title: "加拿大惊悚片榜", value: "ECZMPDHQI" }, { title: "澳大利亚惊悚片榜", value: "EC7QPFMYA" }, { title: "冷门佳作惊悚片榜", value: "ECY4ODRSY" } ] },
                { name: "r_movie_sub_冒险", title: "🔖 榜单名称", type: "enumeration", value: "ECDYOE7WY", belongTo: { paramName: "r_movie_cat", value: ["冒险"] }, enumOptions: [ { title: "近期热门冒险片榜", value: "ECDYOE7WY" }, { title: "高分经典冒险片榜", value: "film_genre_49" }, { title: "华语冒险片榜", value: "ECAUOWGNQ" }, { title: "欧洲冒险片榜", value: "ECW4O3GHY" }, { title: "美国冒险片榜", value: "ECOMON43Q" }, { title: "日本冒险片榜", value: "ECOUOVT2Q" }, { title: "英国冒险片榜", value: "ECFUORHLY" }, { title: "法国冒险片榜", value: "EC5YO53DI" }, { title: "德国冒险片榜", value: "ECMYOXC2Y" }, { title: "加拿大冒险片榜", value: "ECRYO5ULY" }, { title: "澳大利亚冒险片榜", value: "ECFIOR3MY" }, { title: "冷门佳作冒险片榜", value: "ECEMN5MLA" } ] },
                { name: "r_movie_sub_家庭", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_41", belongTo: { paramName: "r_movie_cat", value: ["家庭"] }, enumOptions: [ { title: "高分经典家庭片榜", value: "film_genre_41" } ] },
                { name: "r_movie_sub_儿童", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_42", belongTo: { paramName: "r_movie_cat", value: ["儿童"] }, enumOptions: [ { title: "高分经典儿童片榜", value: "film_genre_42" } ] },
                { name: "r_movie_sub_音乐", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_39", belongTo: { paramName: "r_movie_cat", value: ["音乐"] }, enumOptions: [ { title: "高分经典音乐片榜", value: "film_genre_39" }, { title: "欧洲音乐片榜", value: "ECAQO25QI" }, { title: "美国音乐片榜", value: "ECUAOV5NA" }, { title: "日本音乐片榜", value: "ECFYORPYQ" }, { title: "英国音乐片榜", value: "ECAQO3LYY" }, { title: "法国音乐片榜", value: "ECYAORESI" }, { title: "冷门佳作音乐片榜", value: "EC2UOKJFQ" } ] },
                { name: "r_movie_sub_历史", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_44", belongTo: { paramName: "r_movie_cat", value: ["历史"] }, enumOptions: [ { title: "高分经典历史片榜", value: "film_genre_44" }, { title: "华语历史片榜", value: "ECV4N7YWY" }, { title: "欧洲历史片榜", value: "ECIAOE4OY" }, { title: "美国历史片榜", value: "ECK4OGBSA" }, { title: "中国香港历史片榜", value: "ECPYOEZNY" }, { title: "日本历史片榜", value: "EC54OCODY" }, { title: "韩国历史片榜", value: "ECMAOINLA" }, { title: "英国历史片榜", value: "ECSEOEISY" }, { title: "法国历史片榜", value: "ECUMONVJQ" }, { title: "德国历史片榜", value: "ECNQODGKI" }, { title: "意大利历史片榜", value: "ECL4OLRCY" }, { title: "冷门佳作历史片榜", value: "ECBAOKDHQ" } ] },
                { name: "r_movie_sub_奇幻", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_48", belongTo: { paramName: "r_movie_cat", value: ["奇幻"] }, enumOptions: [ { title: "高分经典奇幻片榜", value: "film_genre_48" }, { title: "华语奇幻片榜", value: "EC5MOJAZY" }, { title: "欧洲奇幻片榜", value: "ECUMOLXQY" }, { title: "美国奇幻片榜", value: "ECVIOIPDI" }, { title: "中国香港奇幻片榜", value: "ECUUOJIFA" }, { title: "日本奇幻片榜", value: "ECEIOJZTQ" }, { title: "韩国奇幻片榜", value: "ECDAOLOSI" }, { title: "英国奇幻片榜", value: "ECRAOGHZY" }, { title: "法国奇幻片榜", value: "EC6QOILRA" }, { title: "德国奇幻片榜", value: "EC4YOCBLQ" }, { title: "冷门佳作奇幻片榜", value: "ECCMOLZQA" } ] },
                { name: "r_movie_sub_恐怖", title: "🔖 榜单名称", type: "enumeration", value: "ECV4N4FBI", belongTo: { paramName: "r_movie_cat", value: ["恐怖"] }, enumOptions: [ { title: "近期热门恐怖片榜", value: "ECV4N4FBI" }, { title: "高分经典恐怖片榜", value: "film_genre_34" }, { title: "华语恐怖片榜", value: "EC54OE5HA" }, { title: "欧洲恐怖片榜", value: "ECFAOK5WQ" }, { title: "美国恐怖片榜", value: "ECGMORRUY" }, { title: "日本恐怖片榜", value: "EC6QOMMWY" }, { title: "韩国恐怖片榜", value: "ECFEOMHIQ" }, { title: "英国恐怖片榜", value: "ECFUOGJDQ" }, { title: "法国恐怖片榜", value: "ECHIOLPXA" }, { title: "西班牙恐怖片榜", value: "ECWUOILKA" }, { title: "泰国恐怖片榜", value: "EC2AOMMKY" }, { title: "加拿大恐怖片榜", value: "ECVYODZIA" }, { title: "澳大利亚恐怖片榜", value: "ECFYOIWBQ" }, { title: "冷门佳作恐怖片榜", value: "ECTMOHSQY" } ] },
                { name: "r_movie_sub_战争", title: "🔖 榜单名称", type: "enumeration", value: "EC6MOCTVQ", belongTo: { paramName: "r_movie_cat", value: ["战争"] }, enumOptions: [ { title: "近期热门战争片榜", value: "EC6MOCTVQ" }, { title: "高分经典战争片榜", value: "film_genre_45" }, { title: "华语战争片榜", value: "ECWUOKOLY" }, { title: "欧洲战争片榜", value: "ECUIOKO6I" }, { title: "美国战争片榜", value: "ECDYONLLI" }, { title: "中国香港战争片榜", value: "ECO4OUYWI" }, { title: "日本战争片榜", value: "ECFYOK3AQ" }, { title: "韩国战争片榜", value: "EC2UOS6AQ" }, { title: "英国战争片榜", value: "ECVIOP57A" }, { title: "法国战争片榜", value: "EC6UOQ3TY" }, { title: "德国战争片榜", value: "ECV4OGCIA" }, { title: "意大利战争片榜", value: "ECYUOU5TA" }, { title: "俄罗斯战争片榜", value: "ECF4OMYDQ" }, { title: "冷门佳作战争片榜", value: "ECGEOIWRA" } ] },
                { name: "r_movie_sub_传记", title: "🔖 榜单名称", type: "enumeration", value: "EC3EOHEYY", belongTo: { paramName: "r_movie_cat", value: ["传记"] }, enumOptions: [ { title: "近期热门传记片榜", value: "EC3EOHEYY" }, { title: "高分经典传记片榜", value: "film_genre_43" }, { title: "华语传记片榜", value: "ECVYOEEUA" }, { title: "欧洲传记片榜", value: "ECZIOQ6LY" }, { title: "美国传记片榜", value: "ECE4OHQQY" }, { title: "英国传记片榜", value: "ECNMONJTQ" }, { title: "法国传记片榜", value: "ECYIOK3PY" }, { title: "德国传记片榜", value: "ECAYOFADY" }, { title: "意大利传记片榜", value: "ECLEOKFFQ" }, { title: "加拿大传记片榜", value: "ECCUOUMXQ" }, { title: "冷门佳作传记片榜", value: "ECRAODXXI" } ] },
                { name: "r_movie_sub_歌舞", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_40", belongTo: { paramName: "r_movie_cat", value: ["歌舞"] }, enumOptions: [ { title: "高分经典歌舞片榜", value: "film_genre_40" }, { title: "欧洲歌舞片榜", value: "EC3QOS5MA" }, { title: "美国歌舞片榜", value: "ECYQOXMSA" }, { title: "冷门佳作歌舞片榜", value: "ECZMOHQ3Q" } ] },
                { name: "r_movie_sub_武侠", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_50", belongTo: { paramName: "r_movie_cat", value: ["武侠"] }, enumOptions: [ { title: "高分经典武侠片榜", value: "film_genre_50" }, { title: "华语武侠片榜", value: "ECEAOOAHI" }, { title: "中国大陆武侠片榜", value: "EC6YOLGQQ" }, { title: "冷门佳作武侠片榜", value: "ECWAOLLZQ" } ] },
                { name: "r_movie_sub_情色", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_37", belongTo: { paramName: "r_movie_cat", value: ["情色"] }, enumOptions: [ { title: "高分经典情色片榜", value: "film_genre_37" }, { title: "华语情色片榜", value: "ECKQOVFTY" }, { title: "欧洲情色片榜", value: "ECVUONKTI" }, { title: "美国情色片榜", value: "ECTQOQ6XQ" }, { title: "日本情色片榜", value: "ECLUOK4TA" }, { title: "韩国情色片榜", value: "ECDMOZMVI" }, { title: "英国情色片榜", value: "ECA4OSUNA" }, { title: "法国情色片榜", value: "ECDAOW2PY" }, { title: "意大利情色片榜", value: "ECM4OVMRY" }, { title: "冷门佳作情色片榜", value: "ECGYN6NHI" } ] },
                { name: "r_movie_sub_灾难", title: "🔖 榜单名称", type: "enumeration", value: "natural_disasters", belongTo: { paramName: "r_movie_cat", value: ["灾难"] }, enumOptions: [ { title: "高分经典灾难片榜", value: "natural_disasters" }, { title: "欧洲灾难片榜", value: "EC5IOQ75I" }, { title: "美国灾难片榜", value: "EC4IOWGKA" }, { title: "冷门佳作灾难片榜", value: "ECHMOGZLQ" } ] },
                { name: "r_movie_sub_西部", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_47", belongTo: { paramName: "r_movie_cat", value: ["西部"] }, enumOptions: [ { title: "高分经典西部片榜", value: "film_genre_47" }, { title: "欧洲西部片榜", value: "ECM4OWDGI" }, { title: "美国西部片榜", value: "ECU4ORYVI" } ] },
                { name: "r_movie_sub_古装", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_51", belongTo: { paramName: "r_movie_cat", value: ["古装"] }, enumOptions: [ { title: "高分经典古装片榜", value: "film_genre_51" } ] },
                { name: "r_movie_sub_运动", title: "🔖 榜单名称", type: "enumeration", value: "ECCEPGM4Y", belongTo: { paramName: "r_movie_cat", value: ["运动"] }, enumOptions: [ { title: "高分经典运动片榜", value: "ECCEPGM4Y" } ] },
                { name: "r_movie_sub_短片", title: "🔖 榜单名称", type: "enumeration", value: "film_genre_36", belongTo: { paramName: "r_movie_cat", value: ["短片"] }, enumOptions: [ { title: "高分经典短片榜", value: "film_genre_36" } ] },
                
                // 电视剧三级分类
                { name: "r_tv_sub_大陆剧", title: "🔖 榜单名称", type: "enumeration", value: "EC74443FY", belongTo: { paramName: "r_tv_cat", value: ["大陆剧"] }, enumOptions: [ { title: "近期热门大陆剧榜", value: "EC74443FY" }, { title: "高分经典大陆剧榜", value: "ECT45KVZI" }, { title: "喜剧大陆剧榜", value: "ECVQ47BUI" }, { title: "爱情大陆剧榜", value: "ECZM5H55I" }, { title: "悬疑大陆剧榜", value: "ECIU5AZDA" }, { title: "家庭大陆剧榜", value: "ECJU5D3PY" }, { title: "古装大陆剧榜", value: "ECTU453WI" }, { title: "犯罪大陆剧榜", value: "EC4Q5JNKI" }, { title: "历史大陆剧榜", value: "ECN45K75A" }, { title: "冷门佳作大陆剧榜", value: "ECRI46YZQ" } ] },
                { name: "r_tv_sub_美剧", title: "🔖 榜单名称", type: "enumeration", value: "ECFA5DI7Q", belongTo: { paramName: "r_tv_cat", value: ["美剧"] }, enumOptions: [ { title: "近期热门美剧榜", value: "ECFA5DI7Q" }, { title: "高分经典美剧榜", value: "ECVACWVGI" }, { title: "喜剧美剧榜", value: "ECX45ISGQ" }, { title: "爱情美剧榜", value: "ECA45D3RQ" }, { title: "悬疑美剧榜", value: "ECKI5JNJI" }, { title: "动作美剧榜", value: "ECME44L4Y" }, { title: "科幻美剧榜", value: "ECL45GQ4I" }, { title: "犯罪美剧榜", value: "EC2Y5CTPA" }, { title: "惊悚美剧榜", value: "ECMM5ALJQ" }, { title: "奇幻美剧榜", value: "ECHU473PI" }, { title: "恐怖美剧榜", value: "ECRE46B7Y" }, { title: "冷门佳作美剧榜", value: "ECGI5HUQI" } ] },
                { name: "r_tv_sub_英剧", title: "🔖 榜单名称", type: "enumeration", value: "ECVACXBWI", belongTo: { paramName: "r_tv_cat", value: ["英剧"] }, enumOptions: [ { title: "高分经典英剧榜", value: "ECVACXBWI" }, { title: "喜剧英剧榜", value: "ECZE5BCZA" }, { title: "悬疑英剧榜", value: "ECTM5HMAI" }, { title: "犯罪英剧榜", value: "EC5I5EOCQ" }, { title: "冷门佳作英剧榜", value: "ECEM4373Q" } ] },
                { name: "r_tv_sub_日剧", title: "🔖 榜单名称", type: "enumeration", value: "ECNA46YBA", belongTo: { paramName: "r_tv_cat", value: ["日剧"] }, enumOptions: [ { title: "近期热门日剧榜", value: "ECNA46YBA" }, { title: "高分经典日剧榜", value: "ECBQCUATA" }, { title: "喜剧日剧榜", value: "ECWM5LNJI" }, { title: "爱情日剧榜", value: "ECEA5D2RQ" }, { title: "悬疑日剧榜", value: "ECHI5FDTQ" }, { title: "冷门佳作日剧榜", value: "ECEA5DW5Q" } ] },
                { name: "r_tv_sub_韩剧", title: "🔖 榜单名称", type: "enumeration", value: "ECBE5CBEI", belongTo: { paramName: "r_tv_cat", value: ["韩剧"] }, enumOptions: [ { title: "近期热门韩剧榜", value: "ECBE5CBEI" }, { title: "高分经典韩剧榜", value: "EC6EC5GBQ" }, { title: "喜剧韩剧榜", value: "ECS45ISKI" }, { title: "爱情韩剧榜", value: "ECOU5ECZQ" }, { title: "冷门佳作韩剧榜", value: "ECZY5IDOY" } ] },
                { name: "r_tv_sub_港剧", title: "🔖 榜单名称", type: "enumeration", value: "ECVM47WUA", belongTo: { paramName: "r_tv_cat", value: ["港剧"] }, enumOptions: [ { title: "高分经典港剧榜", value: "ECVM47WUA" }, { title: "喜剧港剧榜", value: "ECXI5EIII" }, { title: "爱情港剧榜", value: "EC3Y5ISIQ" }, { title: "古装港剧榜", value: "ECIE5FVTI" }, { title: "犯罪港剧榜", value: "EC3A46RGQ" }, { title: "冷门佳作港剧榜", value: "EC3U5ASKQ" } ] },
                { name: "r_tv_sub_台剧", title: "🔖 榜单名称", type: "enumeration", value: "ECBI5EL6A", belongTo: { paramName: "r_tv_cat", value: ["台剧"] }, enumOptions: [ { title: "高分经典台剧榜", value: "ECBI5EL6A" }, { title: "爱情台剧榜", value: "ECBU5LX3A" }, { title: "冷门佳作台剧榜", value: "ECJQ5LAFY" } ] },
                { name: "r_tv_sub_泰剧", title: "🔖 榜单名称", type: "enumeration", value: "ECRM5BIFQ", belongTo: { paramName: "r_tv_cat", value: ["泰剧"] }, enumOptions: [ { title: "高分经典泰剧榜", value: "ECRM5BIFQ" }, { title: "冷门佳作泰剧榜", value: "EC2Y5FJTY" } ] },
                { name: "r_tv_sub_欧洲剧", title: "🔖 榜单名称", type: "enumeration", value: "EC6I5FYHA", belongTo: { paramName: "r_tv_cat", value: ["欧洲剧"] }, enumOptions: [ { title: "近期热门欧洲剧榜", value: "EC6I5FYHA" }, { title: "高分经典欧洲剧榜", value: "ECZY5KBOQ" }, { title: "喜剧欧洲剧榜", value: "ECJQ5LPXY" }, { title: "爱情欧洲剧榜", value: "ECSA5KEKY" }, { title: "悬疑欧洲剧榜", value: "ECEU47F2I" }, { title: "犯罪欧洲剧榜", value: "ECGM5NIQA" }, { title: "冷门佳作欧洲剧榜", value: "ECTM5JVYA" } ] },
                { name: "r_tv_sub_动画剧集", title: "🔖 榜单名称", type: "enumeration", value: "ECR4CRXHA", belongTo: { paramName: "r_tv_cat", value: ["动画剧集"] }, enumOptions: [ { title: "高分经典动画剧集榜", value: "ECR4CRXHA" } ] },
        ...
        {
            title: "豆瓣·电影推荐",
            description: "💡 如未显示筛选参数，请在此处重新点击选择一次【全部】",
            requiresWebView: false,
            functionName: "loadDoubanRecommendMovies",
            params: [
                {
                    name: "m_rec_category", title: "🏷️ 分类", type: "enumeration", value: "全部",
                    enumOptions: [ 
                ...
                {
                    name: "m_filter_score", title: "⭐ 最低评分", type: "enumeration", value: "4",
                    belongTo: { paramName: "m_rec_category", value: ["全部"] },
                    enumOptions: [
        ...
        // --- 模块 8：豆瓣·剧集推荐 ---
        {
            ...
            params: [
                {
                    name: "t_rec_category", title: "🏷️ 分类", type: "enumeration", value: "全部",
                    enumOptions: [
                ...
                {
                    name: "t_filter_platform", title: "📺 平台", type: "enumeration", value: "全部",
                    belongTo: { paramName: "t_rec_category", value: ["全部"] },
                    enumOptions: [
                        { title: "全部", value: "全部" }, { title: "腾讯视频", value: "腾讯视频" }, { title: "爱奇艺", value: "爱奇艺" }, { title: "优酷", value: "优酷" }, { title: "湖南卫视", value: "湖南卫视" }, { title: "Netflix", value: "Netflix" }, { title: "HBO", value: "HBO" }, { title: "BBC", value: "BBC" }, { title: "NHK", value: "NHK" }, { title: "CBS", value: "CBS" }, { title: "NBC", value: "NBC" }, { title: "tvN", value: "tvN" }
                    ]
                },
                {
                    name: "t_filter_sort", title: "🔽 排序方式", type: "enumeration", value: "U",
                    belongTo: { paramName: "t_rec_category", value: ["全部"] },
                    enumOptions: [
                ...
                {
                    name: "t_filter_score", title: "⭐ 最低评分", type: "enumeration", value: "4",
                    belongTo: { paramName: "t_rec_category", value: ["全部"] },
                    enumOptions: [
                        { title: "0", value: "0" }, { title: "1", value: "1" }, { title: "2", value: "2" }, { title: "3", value: "3" }, 
                        { title: "4", value: "4" }, { title: "5", value: "5" }, { title: "6", value: "6" }, { title: "7", value: "7" }, 
...
async function loadDoubanGenreRankings(params = {}) {
    ...
    let targetPathId = "";
    if (params.r_media_type === "movie") {
        const currentCat = params.r_movie_cat || "剧情";
        targetPathId = params[`r_movie_sub_${currentCat}`];
    } else {
        const currentCat = params.r_tv_cat || "大陆剧"; 
        targetPathId = params[`r_tv_sub_${currentCat}`];
    }
...
async function loadDoubanRecommendMovies(params = {}) {
    const limit = parseInt(params.limit) || 20;
    const { start, count } = getPageParams(params, limit);
    const category = params.m_rec_category || "全部";
    
    let apiUrl;
    if (category === "全部") {
        const sortMode = params.m_filter_sort || "U";
        const minScore = params.m_filter_score || "4";
        
        let tagsArray = [];
        if (params.m_filter_genre && params.m_filter_genre !== "全部") tagsArray.push(params.m_filter_genre);
        if (params.m_filter_region && params.m_filter_region !== "全部") tagsArray.push(params.m_filter_region);
        if (params.m_filter_year && params.m_filter_year !== "全部") tagsArray.push(params.m_filter_year);
        ...
        const subType = params.m_rec_type || "全部";
...
async function loadDoubanRecommendShows(params = {}) {
    const limit = parseInt(params.limit) || 20;
    const { start, count } = getPageParams(params, limit);
    const category = params.t_rec_category || "全部";
    
    let apiUrl;
    if (category === "全部") {
        const sortMode = params.t_filter_sort || "U";
        const minScore = params.t_filter_score || "4";
        
        let tagsArray = [];
        if (params.t_filter_genre && params.t_filter_genre !== "全部") tagsArray.push(params.t_filter_genre);
        if (params.t_filter_region && params.t_filter_region !== "全部") tagsArray.push(params.t_filter_region);
        if (params.t_filter_year && params.t_filter_year !== "全部") tagsArray.push(params.t_filter_year);
        if (params.t_filter_platform && params.t_filter_platform !== "全部") tagsArray.push(params.t_filter_platform);
